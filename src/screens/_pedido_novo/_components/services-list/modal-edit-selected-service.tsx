...
type props = {
    ...
    handleAddService:  (service: orderService, quantity: number) => void
    handleDiscount: (discount: number, codeService: number) => void
}




export const ModalEditSelectedService =   ({    isSelected, visible, setVisible, handleAddService , handleDiscount}:props )=>   {
                ...
                >
                  ...
                  <View style={styles.productInfoRow}>
                    ...
                    <View style={styles.priceStockColumn}>
                      <Text style={styles.priceValue}>R$ {Number(isSelected.valor).toFixed(2)}</Text>
                    </View>
                  </View>

                  <Text style={styles.descriptionText} numberOfLines={2}>
                    {isSelected.aplicacao}
                  </Text>
