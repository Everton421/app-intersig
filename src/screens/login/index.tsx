...
const t = ({item}) => {
    ...
    return(
        ...
        <View style={{ flex: 1, backgroundColor: "#EBEBEB" }}>
            ...
            <View style={{ width:"100%",height:"80%", backgroundColor:'#EBEBEB', alignItems:'center',justifyContent:'center'}}>
                    ...
                    {   visibleSelectUser ? (
                      ...
                      {  usuarioSelecionado  !== undefined && (  <Text>{usuarioSelecionado?.nome} </Text>) }
                      </View>
                        ...
                        {  usuarioSelecionado  !== undefined ? (  <Text>{usuarioSelecionado?.nome} </Text>) : (  <Text>Login </Text>)  }
                      </View>
                    )
                    }
                    </TouchableOpacity>
                          ...
                          {visibleSelectUser &&
                                      ...
                                      <View style={{
                                            margin: 10, backgroundColor: '#EBEBEB', borderRadius: 10, width: '96%',
                                            height: '30%' ,
